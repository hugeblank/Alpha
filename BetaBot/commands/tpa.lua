...
if args[1] ~= nil then
    print(bagelBot.tell(args[1], name.." would like to teleport to you, type or click: &6&h(Click to Teleport)&g(!tpaccept "..name..")!tpaccept "..name.."&r to accept"), false, betaBot.name)
