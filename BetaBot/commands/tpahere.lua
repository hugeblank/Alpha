...
if args[1] ~= nil then
    print(bagelBot.tell(args[1], name.." would like you to teleport to them, type or click: &6&h(Click to Teleport)&g(!tpaccept "..name..")!tpaccept "..name.."&r to accept", false, betaBot.name))
